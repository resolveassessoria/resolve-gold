    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin/usuarios" element={<AdminProtectedRoute requiredSubRoles={["admin_suporte", "admin_full"]}><AdminUsuarios /></AdminProtectedRoute>} />
          <Route path="/admin/transacoes" element={<AdminProtectedRoute requiredSubRoles={["admin_financeiro", "admin_full"]}><AdminTransacoes /></AdminProtectedRoute>} />
          <Route path="/admin/kyc" element={<AdminProtectedRoute requiredSubRoles={["admin_kyc", "admin_full"]}><AdminKyc /></AdminProtectedRoute>} />
          <Route path="/admin/marketplace" element={<AdminProtectedRoute requiredSubRoles={["admin_financeiro", "admin_full"]}><AdminMarketplace /></AdminProtectedRoute>} />
          <Route path="/admin/auditoria" element={<AdminProtectedRoute requiredSubRoles={["admin_full"]}><AdminAuditoria /></AdminProtectedRoute>} />
